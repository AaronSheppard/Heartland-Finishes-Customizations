// report 50009 "HF Receiving Ticket HL"
// {
//     // version AI9.01.03,HL

//     DefaultLayout = RDLC;
//     RDLCLayout = '.vscode/src/Reports/Layouts/Receiving Ticket HL.rdlc';
...
//                     {
//                     }
//                     column(PrintAssingments; "Purchase Header"."Print Assignments")
//                     {
//                     }
...
//                                             WHERE("CERP Print on PO" = CONST(Yes),
...
//                         {
//                         }
//                         column(Submittal_Description__DescToPrint; "Submittal Description" + ' ' + DescToPrint)
//                         {
//                         }
...
//                         {
//                         }
//                         column(Purchase_Line_Associated_Document_No; "Associated Document No.")
//                         {
//                         }
//                         column(Purchase_Line_Associated_Line_No; "Associated Line No.")
//                         {
//                         }
...
//                         {
//                         }
//                         column(Purchase_Line_StagingLoc; PurchLine."Staging Location")
//                         {
//                         }
//                         column(Purchase_Line_Contract_Description; ContractName)
//                         {
//                         }
...
//                         {
//                             DataItemLink = "Document No."=FIELD(Associated Document No.),
//                                            Line No.=FIELD(Associated Line No.);
...
//                                         "Purchase Line"."Product Group Code",PrintOn::"Receiving Ticket")) THEN
//                                   CurrReport.SKIP;
//                             end;
...
//                                   THEN SETRANGE("Document Type","Document Type"::Shop)
//                                   ELSE SETRANGE("Document Type","Document Type"::Order);

//                                 IF "Purchase Line"."Associated Comp. Line No." = 0
//                                   THEN PrintAttributes := TRUE        //Purchasing Parent Line.
//                                   ELSE IF MainComp.GET("Purchase Line"."Component Document Type","Purchase Line"."Component Document No.",
//                                                        "Purchase Line"."Component Sales Line No.","Purchase Line"."Component Line No.") AND
//                                           MainComp."Main Component"
//                                          THEN PrintAttributes := TRUE //Purchasing Main Component.
//                                          ELSE PrintAttributes := FALSE;
...
//                                         THEN IF ConfigSetup.GET(tempShopOrderParent."Configurator Setup No.") THEN;
//                                     END;
//                             end;
//                         }
//                         dataitem(DataItem2535;Table37004507)
//                         {
//                             DataItemLink = "Contract No."=FIELD(Associated Document No.),
//                                            Change Order No.=FIELD(Associated Change Order No.),
//                                            Material Entry No.=FIELD(Associated Line No.);
...
//                                 IF "Purchase Line"."Associated Comp. Line No." = 0
//                                   THEN PrintAttributes := TRUE        //Purchasing Parent Line.
//                                   ELSE IF MainComp.GET("Purchase Line"."Associated Document No.","Purchase Line"."Associated Change Order No.",
...
//                                           THEN IF ConfigSetup.GET(MatList."Configurator Setup No.") THEN;
//                             end;
//                         }
//                         dataitem("Component Attribute";"CERP Component")
//                         {
//                             DataItemLink = "Document Type"=FIELD(Component Document Type),
//                                            "Document No."=FIELD(Component Document No.),
//                                            Line No.=FIELD(Component Sales Line No.),
//                                            Parent Component Line No.=FIELD(Component Line No.);
...
//                                   THEN PrintAttributes := FALSE
//                                   ELSE
//                                     IF MainComp.GET("Purchase Line"."Component Document Type","Purchase Line"."Component Document No.",
//                                                        "Purchase Line"."Component Sales Line No.","Purchase Line"."Component Line No.") AND
//                                           MainComp."Main Component"
//                                          THEN PrintAttributes := FALSE; //Purchasing Main Component.
//                             end;
//                         }
//                         dataitem("Material Component Attribute";Table37004507)
//                         {
//                             DataItemLink = "Contract No."=FIELD(Contract No.),
//                                            Change Order No.=FIELD(Change Order No.),
//                                            Material Entry No.=FIELD(Material Entry No.),
//                                            Parent Component Line No.=FIELD(Material Comp. Line No.);
...
//                                   THEN "Purchase Line".AssignmentArrayByReport(REPORT::"CD Purchase Order",120,AssignArray);
//                             end;
//                         }
...
//                         begin
//                             //AI9.01.03 JPU 08222018 BEGIN - Only store the CompanyInformation record (Picture) on 1st record of dataset
//                             IF HasProcessed1stLine THEN
//                               CLEAR(CompanyInformation)
//                             ELSE
//                               HasProcessed1stLine  := TRUE;
//                             //AI9.01.03 JPU 08222018 END
...
//                               THEN AssignPrintDetail := TRUE
//                               ELSE
//                                 CASE AssignPrintOptions.Print OF
//                                   AssignPrintOptions.Print::"Assignment Detail (PO & Shop Only)" : AssignPrintDetail := TRUE;
//                                   AssignPrintOptions.Print::"Assignments and Keying" : AssignAndKeyingPrint := TRUE;
//                                   AssignPrintOptions.Print::"Assignments and Qty. (PO Only)" : AssignAndQtyPrint := TRUE;
//                                 END;

//                             IF ProductGroup.GET("Item Category Code","Product Group Code") THEN;

//                             //HL JPU 04022019 BEGIN
//                             ContractName := '';
//                             IF "Associated Document Type" = "Associated Document Type"::Contract THEN BEGIN
//                               IF Contract.GET("Associated Document No.", "Associated Change Order No.") THEN
//                                 ContractName := Contract.Description;
//                             END ELSE IF "Associated Document Type" = "Associated Document Type"::"Sales Order" THEN BEGIN
//                               IF SalesHeader.GET(SalesHeader."Document Type"::Order, "Associated Document No.") THEN
//                                 ContractName := SalesHeader."Contract Description";
//                             END;
//                             //HL JPU 04022019 END
...
//             begin
//                 HasProcessed1stLine := FALSE; //AI9.01.03 JPU 0822201
...
//                 //AI9.01 JPU 05092017 BEGIN
//                 IF PrintOrderBarcode
//                   THEN OrderBarcode := BarcodeMgmt.GetBarcode(DATABASE::"Purchase Header","Document Type","No.",'',rBarcode.Level::Order,0,0,'','','','',0,0D,'',0,0,0,'','',0,0);
//                 //AI9.01 JPU 05092017 END
//             end;
...
//         QtyToRecCaption = 'Quantity To Receive';
...
//         TaxCaption = 'Tax:';
//         EMailCaption = 'Email:';
//         StageLocCaption = 'Staging Location';
//         AssociatedDocCaption = 'Associated Doc Nbr';
//     }
...
//         PrintOn: Option ShopOrder,PurchaseOrder,"Picking Ticket","Packing Slip","Receiving Ticket";
